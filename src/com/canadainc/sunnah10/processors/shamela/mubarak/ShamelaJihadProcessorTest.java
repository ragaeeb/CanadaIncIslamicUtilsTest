...
public class ShamelaJihadProcessorTest
{
	...
	public void testProcess() throws IOException
	{
		...
		SunnahTestUtils.loadAndAssertShamelaSize("jihad/003.txt", s, 1);
		...
		SunnahTestUtils.loadAndAssertShamelaSize("jihad/019.txt", s, 3);
		...
		SunnahTestUtils.loadAndAssertShamelaSize("jihad/155.txt", s, 4);
		SunnahTestUtils.assertNarration(s.getNarrations().get(3), 20, null,
				"الزمر: 30");

		SunnahTestUtils.loadAndAssertShamelaSize("jihad/215.txt", s, 5);
