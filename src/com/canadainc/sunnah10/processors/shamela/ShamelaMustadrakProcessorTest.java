...
public class ShamelaMustadrakProcessorTest
{
	...
	public void testProcess() throws IOException
	{
		...
		SunnahTestUtils.loadAndAssertShamelaSize("mustadrak/0004.txt", s, 1);
		...
		// 2 in 1
		SunnahTestUtils.loadAndAssertShamelaSize("mustadrak/0081.txt", s, 3);
		...
		SunnahTestUtils.loadAndAssertShamelaSize("mustadrak/0169.txt", s, 5);
