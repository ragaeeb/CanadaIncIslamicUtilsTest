...
public class ShamelaAwaanahProcessorTest
{
	...
	{
		ShamelaTestUtils.loadAndAssertSize("awaanah/0003.txt", s, 2);
	...
	public void testDisconnected() throws IOException {
		ShamelaTestUtils.loadAndAssertSize("awaanah/0018.txt", s, 0);
		ShamelaTestUtils.loadAndAssertSize("awaanah/0031.txt", s, 0);
	}


	@Test
	public void testTypoFix() throws IOException {
		ShamelaTestUtils.loadAndAssertSize("awaanah/0010.txt", s, 2);
		ShamelaTestUtils.assertNarration(s.getNarrations().get(0), 10, null,
				"حَدَّثَنَا مُحَمَّدُ بْنُ حَيَّوَيْهِ", "لَا إِلَهَ إِلَّا اللَّهُ دَخَلَ الْجَنَّةَ");
		ShamelaTestUtils.assertNarration(s.getNarrations().get(1), 11, null,
	...
	public void testEmptyBody() throws IOException {
		ShamelaTestUtils.loadAndAssertSize("awaanah/2775.txt", s, 1);
		ShamelaTestUtils.assertNarration(s.getNarrations().get(0), 2964, null,
	...
	public void testMultiPages() throws IOException {
		ShamelaTestUtils.loadAndAssertSize("awaanah/6478.txt", s, 1);
		ShamelaTestUtils.loadAndAssertSize("awaanah/6479.txt", s, 1);
